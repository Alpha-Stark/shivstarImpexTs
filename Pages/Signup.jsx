...
export const SignUp = ({ setLogsign }) => {
    ...
    return (
        <>
            ...
            >
                <Heading color={"black"} fontSize={"2xl"} textAlign={"center"} paddingBottom={"0.8rem"}>
                    Sign up
                </Heading>
                <form
                    style={{
                            ...
                            <Box rounded={"lg"} bg={useColorModeValue("white", "gray.700")} boxShadow={"lg"} p={8}>
                                <Stack spacing={4}>
                                    ...
                                    <Stack pt={1}>
                                        <Text align={"center"}>
                                            Already a user?{" "}
                                            <Button variant="link" onClick={() => setLogsign(false)} color={"rgb(255,189,89)"} fontWeight={"600"}>
                                                Login
                                            </Button>
                                        </Text>
                                    </Stack>
