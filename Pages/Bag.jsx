        ...
        <>
            <div className={styles.cartandpaymentbox}>
                <div className={styles.firstbox}>
                    {cartArray.length === 0 ? (
                        <p style={{ fontWeight: "bold", marginTop: "20px" }}>Your cart is empty.</p>
                    ) : (
                        cartArray.map((temp) => (
                            <div key={temp.id} className={styles.cartbox}>
                                ...
                                <div className={styles.cartdetails}>
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            dispatch({ type: DELETE_CART, payload: temp });
                                        }}
                                    >
                                        {" "}
                        ...
                        <form onSubmit={cardpaymentoption}>
                            <div style={formRowStyle}>
                                <div style={formGroupStyle}>
                                    ...
                                    <input type="text" id="firstName" placeholder="Enter your first name" required style={inputStyle} />
                                </div>
                                ...
                                <div style={formGroupStyle}>
                                    ...
                                    <input type="text" id="landmark" placeholder="Enter a landmark" required style={inputStyle} />
                                </div>
                                <div style={formGroupStyle}>
                                    <label htmlFor="city" style={labelStyle}>
                                        City <span style={{ color: "red" }}>*</span>
                                    </label>
                                    <input type="text" id="city" placeholder="Enter your city" required style={inputStyle} />
                                </div>
                                <div style={formGroupStyle}>
                                    <label htmlFor="state" style={labelStyle}>
                                        State <span style={{ color: "red" }}>*</span>
                                    </label>
                                    <input type="text" id="state" placeholder="Enter your state" required style={inputStyle} />
                                </div>
                                <div style={formGroupStyle}>
                                    <label htmlFor="pinCode" style={labelStyle}>
                                        Pin Code <span style={{ color: "red" }}>*</span>
                                    </label>
                                    <input type="number" id="pinCode" placeholder="Enter your pin code" required style={inputStyle} />
                                </div>
                            </div>
                    ...
                    <div style={formContainerStyle}>
                        ...
                        >
                            ...
                            <div style={formGroupStyle}>
                                ...
                                <input type="number" id="cardNumber" name="cardNumber" placeholder="Enter your card number" required style={inputStyle} />
                            </div>
                            <div style={formGroupStyle}>
                                <label htmlFor="cardHolder" style={labelStyle}>
                                    Card Holder <span style={{ color: "red" }}>*</span>
                                </label>
                                <input type="text" id="cardHolder" name="cardHolder" placeholder="Enter the cardholder's name" required style={inputStyle} />
                            </div>
                            <div style={formGroupStyle}>
                                <label htmlFor="expiryDate" style={labelStyle}>
                                    Expiry Date <span style={{ color: "red" }}>*</span>
                                </label>
                                <input type="text" id="expiryDate" name="expiryDate" placeholder="MM/YY" required style={inputStyle} />
                            </div>
                            <div style={formGroupStyle}>
                                <label htmlFor="cvc" style={labelStyle}>
                                    CVV <span style={{ color: "red" }}>*</span>
                                </label>
                                <input type="number" id="cvc" name="cvc" placeholder="Enter the security code" required style={inputStyle} />
                            </div>
                                ...
                                <div className={styles.modal}>
                                    ...
                                    <div className={styles.modalContent}>
                                        <Alert status="success" variant="subtle" flexDirection="column" alignItems="center" justifyContent="center" textAlign="center" height="200px">
                                            ...
                                            <AlertDescription maxWidth="sm">Thank you for payment, Visit again!</AlertDescription>
                                        </Alert>
